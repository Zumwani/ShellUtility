...
#region Pinvoke
        ...
        public static string GetAppID(IntPtr window)
        {
            ...
            var result = "";
            EnumChildWindows(window, new EnumWindowsProc((handle, lParam) =>
            {
        ...
        public static BitmapSource GetIcon(string appID)
        {
            ...
            var package = new PackageManager().FindPackagesForUser("").FirstOrDefault(p => p.Id.FamilyName == familyName);
